...
// 这种解法 不能涵盖 第二个参数为false 或者是boolean 这种情况
...
// 这种方法不知道为什么有问题 ( )
// Expect<Equal<Includes<[null], undefined>, false>>, 这个例子会有问题,当进行了第一次循环之后,当前的T 变成了空数组,而取第一个(也就是undefined)进行比较的话,就会得到true 的结果
// type Includes<T extends readonly unknown[], U> = Equal<U, T[0]> extends true
//   ?
//   true
//   :

...
type CheckRepeatedTuple<T extends unknown[]> = T extends [infer HEAD, ...infer TAIL] ? Includes<TAIL, HEAD> extends true ? true : CheckRepeatedTuple<TAIL> : false

...
type Without<T extends readonly any[], U> = T extends [infer HEAD, ...infer TAIL] ?
  HEAD extends (U extends readonly any[] ? U[number] : U) ? Without<TAIL, U> : [HEAD, ...Without<TAIL, U>]
  : []

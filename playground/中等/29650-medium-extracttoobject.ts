...
type ExtractToObject<T, U extends keyof T> = {
  [P in Exclude<keyof T, U> | keyof T[U]]: P extends Exclude<keyof T, U> ? T[P] : P extends keyof T[U] ? T[U][P] : never
}
type C = ExtractToObject<test1, 'myProp'>
//   ^?
type C2 = ExtractToObject<test2, 'prop2'>
//   ^?
